...
class Block(models.Model):
    block_id = models.IntegerField(verbose_name='Высота блока', max_length=8, unique=True, primary_key=True)
    ...
    num_trans_in_block = models.IntegerField(verbose_name='Количество транзакций в блоке', max_length=16)
